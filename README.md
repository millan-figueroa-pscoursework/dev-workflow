...
-- vite.config.ts - `import tailwindcss from '@tailwindcss/vite'`<br>
-- add tailwind to plugins array: `[    tailwindcss(), react()  ],`<br>

6. **Setup styles**: 
-- index.css - add `@import "tailwindcss"` at the top<br>
-- this will be your this your main styles file <br>

7. **Clean Up**: delete boilerplate folder, files, code, and related imports: <br>
-- delete public + assets folders, App.css <br>
-- index.html: delete svg (no need to add css file here when you're using react), update title <br>
...
13. **Make First Commit**: initiate local repo and make first commit:
-- `git init` <br>
-- `git add .` <br>
...
14. **Manage Time Wisely, Make a Plan**: strategize a plan for the project before you start coding! <br>
